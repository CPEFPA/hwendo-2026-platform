...
console.log('🔧 Réécriture complète de Statistiques.jsx...\n');

const newStatistiques = `import { useState, useEffect } from 'react';
...
fs.writeFileSync(
  path.join(__dirname, 'src/components/Statistiques.jsx'),
  newStatistiques,
  'utf8'
);

console.log('✅ Statistiques.jsx réécrit complètement !');
console.log('   - Caractères propres (via String.fromCodePoint)');
console.log('   - Participants/Signés depuis le backend (synchronisés)');
console.log('   - Photos/Vidéos/Audios depuis IndexedDB local');
console.log('   - Graphiques en CSS pur (fiables)');
console.log('   - Carte des villages intégrée');