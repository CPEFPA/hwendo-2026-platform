...
console.log('🔧 Correction PDF : cases à cocher + photos/signatures...\n');
...
console.log('✅ PDFGenerator corrige avec cases à cocher visuelles');
console.log('✅ Fonction drawCheckbox pour cases claires');
console.log('✅ Photos et signatures correctement chargees');