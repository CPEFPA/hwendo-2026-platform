...
// CoordonnÃ©es des villages du BÃ©nin (royaume Hwendo et environs)
const VILLAGE_COORDS = {
  ...
  'come': [6.3969, 1.8786], 'comÃ©': [6.3969, 1.8786],
  ...
  'ketou': [7.3667, 2.6000], 'kÃ©tou': [7.3667, 2.6000],
  'sakete': [6.7333, 2.6500], 'sakÃ©tÃ©': [6.7333, 2.6500],
  'pobe': [6.9833, 2.6667], 'pobÃ¨': [6.9833, 2.6667],
  'lokossa': [6.6389, 1.7167],
  'dogbo': [6.7833, 1.7833],
  'aplahoue': [6.8333, 1.7333], 'aplahouÃ©': [6.8333, 1.7333],
  'klouekanme': [6.8667, 1.9833], 'klouÃ©kanmÃ©': [6.8667, 1.9833],
  'abobo': [5.4167, 2.0167],
  'adjara': [6.4833, 2.6833],
  'adjarra': [6.4500, 2.7333],
  'seme': [6.4333, 2.5833], 'sÃ¨mÃ¨': [6.4333, 2.5833],
  'kpomasse': [6.4167, 2.0500], 'kpomassÃ¨': [6.4167, 2.0500],
  'torou': [7.0500, 2.0500],
  'bohicon': [7.1783, 2.0667],
  'zagnanado': [7.0833, 2.1333],
  'covÃ©': [7.0833, 2.3000], 'cove': [7.0833, 2.3000],
  'zakin': [7.0167, 2.1500],
  'dassa': [7.7833, 2.1667],
  'save': [8.0333, 2.4833], 'savÃ©': [8.0333, 2.4833],
  ...
  'lome': [6.1319, 1.2228], 'lomÃ©': [6.1319, 1.2228],
  'aneho': [6.2333, 1.5833], 'anÃ©ho': [6.2333, 1.5833]
};
  ...
  return (
    <div>
      ...
      <p style={{fontSize: '11px', color: '#6B5D54', marginTop: '8px', fontStyle: 'italic'}}>
        ðŸ—ºï¸ Les cercles ocre indiquent le nombre de participants par village. Cliquez sur un cercle pour le dÃ©tail.
      </p>
    </div>
  );
}
