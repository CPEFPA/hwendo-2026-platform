...
console.log('🔧 Mise à jour de CarteVillages.jsx...\n');

const newCarte = `import { useEffect, useRef, useState } from 'react';
...
fs.writeFileSync(
  path.join(__dirname, 'src/components/CarteVillages.jsx'),
  newCarte,
  'utf8'
);

console.log('✅ CarteVillages.jsx mis à jour !');
console.log('   - Carte centrée sur Ouidah / Atlantique (Bénin)');
console.log('   - 30 villages avec coordonnées exactes');
console.log('   - Sélecteur Plan / Satellite');
console.log('   - Géocodage automatique des villages inconnus');