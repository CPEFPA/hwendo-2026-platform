...
console.log('🔧 Ajout du bouton Réinitialiser dans DetenteurList.jsx...\n');
...
function DetenteurList() {
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      // 2. Vider le backend si en ligne
      if (navigator.onLine) {
        try {
...
console.log('✅ Bouton Réinitialiser ajouté !');
console.log('   - Bouton rouge à côté de Rafraîchir');
console.log('   - Double confirmation (taper SUPPRIMER)');
console.log('   - Vide IndexedDB local + backend Render');